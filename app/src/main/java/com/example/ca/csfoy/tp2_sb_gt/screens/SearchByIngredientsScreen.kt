...
fun SearchByIngredientsView(recipeViewModel: RecipeViewModel, onClick: () -> Unit) {
    Column(Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
        Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
            Text(
                text = stringResource(R.string.recipes_found_text) + recipeViewModel.displayedSearchText,
        ...
        LazyColumn(
            ...
            if (recipeViewModel.displayedSearchText.isBlank()) {
                item {
                    Text(
                        text = stringResource(R.string.no_ingredients_entered_text),
                        color = MaterialTheme.colorScheme.tertiary,
                        style = MaterialTheme.typography.bodyLarge
                    )
                }
                ...
                item {
                    Text(
                        text = stringResource(R.string.no_recipes_found_text) + recipeViewModel.displayedSearchText,
                        color = MaterialTheme.colorScheme.tertiary,
                        style = MaterialTheme.typography.bodyLarge
                    )
                }
